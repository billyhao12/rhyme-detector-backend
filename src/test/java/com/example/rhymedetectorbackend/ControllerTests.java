...
public class ControllerTests {
    ...
    void shouldHighlightMultisyllableRhymes() throws Exception {
        LyricsInput lyricsInput = new LyricsInput("His palms are sweaty, knees weak, arms are heavy\nThere's vomit on his sweater already, mom's spaghetti\nHe's nervous, but on the surface, he looks calm and ready\nTo drop bombs, but he keeps on forgetting");
        ...
        Map<String, Object> actualResponse = restTemplate.postForObject("http://localhost:" + port + "/rhymes/multisyllable", lyricsInput, Map.class);
